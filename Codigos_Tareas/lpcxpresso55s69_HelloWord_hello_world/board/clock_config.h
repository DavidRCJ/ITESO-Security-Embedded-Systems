...
#define BOARD_BOOTCLOCKRUN_ASYNCADC_CLOCK             0UL            /* Clock consumers of ASYNCADC_clock output : ADC0 */
...
#define BOARD_BOOTCLOCKRUN_OSC32KHZ_CLOCK             0UL            /* Clock consumers of OSC32KHZ_clock output : FLEXCOMM0, FLEXCOMM1, FLEXCOMM2, FLEXCOMM3, FLEXCOMM4, FLEXCOMM5, FLEXCOMM6, FLEXCOMM7, FLEXCOMM8, USBHSD, USBHSH, USBPHY */
#define BOARD_BOOTCLOCKRUN_OSTIMER32KHZ_CLOCK         0UL            /* Clock consumers of OSTIMER32KHZ_clock output : OSTIMER */
...
#define BOARD_BOOTCLOCKRUN_SDIO_CLOCK                 0UL            /* Clock consumers of SDIO_clock output : SDIF */
#define BOARD_BOOTCLOCKRUN_SYSTICK0_CLOCK             0UL            /* Clock consumers of SYSTICK0_clock output : N/A */
#define BOARD_BOOTCLOCKRUN_SYSTICK1_CLOCK             0UL            /* Clock consumers of SYSTICK1_clock output : N/A */
...
#define BOARD_BOOTCLOCKRUN_USB1_PHY_CLOCK             0UL            /* Clock consumers of USB1_PHY_clock output : USBHSD, USBHSH, USBPHY */
...
#define BOARD_BOOTCLOCKFROHF96M_WDT_CLOCK             1000000UL      /* Clock consumers of WDT_clock output : WWDT */
